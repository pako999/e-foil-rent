...
/** YouTube ID of the Duotone foil setup walkthrough. */
const VIDEO_ID = "QTArwk0Blk0";

/**
 * Standalone YouTube facade for the "how to set up your foil" tutorial.
 * Mirrors the lightweight pattern used by <Video />: only the thumbnail
 * loads on first paint; the heavy iframe mounts on click.
 */
export function FoilSetupVideo() {
    ...
    <section className="bg-paper border-b-2 border-ink">
      <div className="container-x py-20">
        ...
        >
          {open ? (
            <iframe
              src={`https://www.youtube.com/embed/${VIDEO_ID}?autoplay=1&rel=0&start=5`}
              title={t("title")}
            ...
            >
              ...
              <span className="absolute inset-0 flex items-center justify-center">
                <span
                  className="flex items-center justify-center w-20 h-20 bg-gold border-2 border-ink group-hover:scale-110 transition-transform"
